    ...
    <div className="max-w-7xl mx-auto px-6 pt-24 pb-32">
      <div className="grid lg:grid-cols-2 gap-24 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.1] text-white uppercase max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 pt-6">
            <button
              onClick={onStart}
              className="group relative px-12 py-6 bg-gradient-to-br from-gold-light via-gold to-gold-dark rounded-2xl text-vertus-black font-black text-xl tracking-tight uppercase shadow-2xl shadow-gold/20 hover:shadow-gold/40 hover:scale-[1.02] transition-all flex items-center justify-center gap-4 overflow-hidden"
            >
            ...
            {onContinue && (
              <button
                onClick={onContinue}
                className="group px-8 py-4 bg-white/5 border border-white/10 rounded-2xl text-white font-bold text-sm uppercase tracking-widest hover:bg-gold/10 hover:border-gold/30 transition-all flex items-center gap-3"
              >
      ...
      <div className="grid md:grid-cols-3 gap-16 mt-40">
        {[
          ...
          <motion.div
            ...
            className="p-12 bg-vertus-gray border border-white/10 rounded-[40px] hover:border-gold/30 transition-all group relative overflow-hidden shadow-2xl shadow-transparent hover:shadow-gold/5"
          >
            ...
            <div className="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-gold/20 transition-colors">
              <feature.icon className="text-white/40 group-hover:text-gold transition-colors" size={32} />
            </div>
            <h3 className="text-2xl font-black mb-4 text-white group-hover:text-gold transition-colors uppercase tracking-tight">{feature.title}</h3>
      ...
      <div className="mt-32 pt-12 border-t border-white/5 flex flex-col items-center gap-4">
        <p className="text-[9px] font-black uppercase tracking-[0.4em] text-white/5">VERTUS SISTEMAS ESTRATÉGICOS</p>
      </div>
    </div>
  );
}
